                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <router-link active-class="active" to="/requests" class="nav-link d-flex align-items-center">
                            ...
                            <span>Requests ({{ DB::table('telescope_entries')->whereType('request')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/commands" class="nav-link d-flex align-items-center">
                            ...
                            <span>Commands ({{ DB::table('telescope_entries')->whereType('command')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/schedule" class="nav-link d-flex align-items-center">
                            ...
                            <span>Schedule ({{ DB::table('telescope_entries')->whereType('schedule')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/jobs" class="nav-link d-flex align-items-center">
                            ...
                            <span>Jobs ({{ DB::table('telescope_entries')->whereType('job')->count() }})</span>
                        </router-link>
                    </li>
                    ...
                    <li class="nav-item mt-3">
                        <router-link active-class="active" to="/batches" class="nav-link d-flex align-items-center">
                            ...
                            <span>Batches ({{ DB::table('telescope_entries')->whereType('batch')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/cache" class="nav-link d-flex align-items-center">
                            ...
                            <span>Cache ({{ DB::table('telescope_entries')->whereType('cache')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/dumps" class="nav-link d-flex align-items-center">
                            ...
                            <span>Dumps ({{ DB::table('telescope_entries')->whereType('dump')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/events" class="nav-link d-flex align-items-center">
                            ...
                            <span>Events ({{ DB::table('telescope_entries')->whereType('event')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/exceptions" class="nav-link d-flex align-items-center">
                            ...
                            <span>Exceptions ({{ DB::table('telescope_entries')->whereType('exception')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/gates" class="nav-link d-flex align-items-center">
                            ...
                            <span>Gates ({{ DB::table('telescope_entries')->whereType('gate')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/client-requests" class="nav-link d-flex align-items-center">
                            ...
                            <span>HTTP Client ({{ DB::table('telescope_entries')->whereType('client_request')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/logs" class="nav-link d-flex align-items-center">
                            ...
                            <span>Logs ({{ DB::table('telescope_entries')->whereType('log')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/mail" class="nav-link d-flex align-items-center">
                            ...
                            <span>Mail ({{ DB::table('telescope_entries')->whereType('mail')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/models" class="nav-link d-flex align-items-center">
                            ...
                            <span>Models ({{ DB::table('telescope_entries')->whereType('model')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/notifications" class="nav-link d-flex align-items-center">
                            ...
                            <span>Notifications ({{ DB::table('telescope_entries')->whereType('notification')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/queries" class="nav-link d-flex align-items-center">
                            ...
                            <span>Queries ({{ DB::table('telescope_entries')->whereType('query')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/redis" class="nav-link d-flex align-items-center">
                            ...
                            <span>Redis ({{ DB::table('telescope_entries')->whereType('redis')->count() }})</span>
                        </router-link>
                    </li>
                    <li class="nav-item">
                        <router-link active-class="active" to="/views" class="nav-link d-flex align-items-center">
                            ...
                            <span>Views ({{ DB::table('telescope_entries')->whereType('view')->count() }})</span>
                        </router-link>
                    </li>
                </ul>
            </div>
